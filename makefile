...
CFLAGS=-Os -m68000 -noixemul -fomit-frame-pointer -nostartfiles -mregparm=3 -msmall-code \
	-DMIN_LIB_VERSION=33 -DKSWRAPPER=1 -DSCSIDIRECT=1 -DNSD=1 -DTD64=1 -DTRACKDISK=1 \
	-DLARGE_FILE_SIZE=0 -DEXTRAPACKETS=1 -DSIZEFIELD -DDELDIR=1 -DMAX_BUFFERS=600 -DMIN_BUFFERS=20 \
